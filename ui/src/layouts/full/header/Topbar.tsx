        ...
        <div className="flex items-center gap-12">
          ...
          <div className="lg:flex items-center gap-3 hidden">
            <Link
              ...
              className="flex items-center gap-1 text-white bg-transparent hover:bg-primary py-2 px-3 rounded-md"
            >
        ...
        <div className="flex items-center gap-2 flex-wrap justify-center lg:mt-0 mt-2">
          ...
          >
            {dropdownItems.map((item) => {
              return (
                <Dropdown.Item
                  className="flex items-center gap-1 text-sm py-2.5 px-4 group"
                  as={Link}
                  to={item.href}
                  icon={() => (
                    <Icon
                      icon="tabler:external-link"
                      className="text-lg text-link group-hover:text-primary"
                    />
                  )}
                >
                  {item.title}
