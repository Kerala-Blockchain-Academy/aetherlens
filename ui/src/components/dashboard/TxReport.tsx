...
const TxReport = () => {
  ...
  const SubChart = async () => {
    ...
    const last10Days = Array.from(
      { length: 10 },
      (_, i) => dayjs().subtract(i, 'day').format('DD/MM'), // Format: 01/03, 02/03...
        ...
        <div className="inline-flex rounded-full border border-gray-300 overflow-hidden">
          <button
            ...
            className={`px-8 py-2 text-sm font-medium focus:outline-none ${
              selected === 'today' ? 'bg-blue-600 text-white' : 'bg-white text-gray-800'
            } rounded-l-full`}
          >
            Today
          </button>
          ...
          <button
            ...
            className={`px-4 py-2 text-sm font-medium focus:outline-none border-l border-gray-300 ${
              selected === 'last10' ? 'bg-blue-600 text-white' : 'bg-white text-gray-800'
            } rounded-r-full`}
          >
            Last 10 Days
          </button>
